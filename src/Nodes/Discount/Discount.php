...
class Discount extends NodeAbstract
{
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/add', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/items/add', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/delete', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/item/delete', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/detail', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discounts/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/update', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/discount/items/update', $parameters);
    }
}

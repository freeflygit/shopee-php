...
class Logistics extends NodeAbstract
{
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/address/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/airway_bill/get_mass', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/branch/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/forder_waybill/get_mass', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/channel/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/init_info/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/tracking', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/order/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/init_parameter/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/timeslot/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/tracking_number/get_mass', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/init', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/offline/set', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/tracking_number/set_mass', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/logistics/channels/update', $parameters);
    }
}

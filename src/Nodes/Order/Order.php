...
class Order extends NodeAbstract
{
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/my_income', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/get_escrow_detail', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/forder/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/detail', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/basics', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/buyer_cancellation/accept', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/note/add', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/cancel', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/buyer_cancellation/reject', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/split', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/orders/unsplit', $parameters);
    }
}

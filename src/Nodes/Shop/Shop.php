...
class Shop extends NodeAbstract
{
    ...
    {
        return $this->post('/api/'.$this->version.'/shop/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop/performance', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop/set_installment_status', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop/update', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop/get_partner_shop', $parameters);
    }
}

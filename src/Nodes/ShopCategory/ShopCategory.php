...
class ShopCategory extends NodeAbstract
{
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/add', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_categorys/get', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/delete', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/update', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/add/items', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/get/items', $parameters);
    }
    ...
    {
        return $this->post('/api/'.$this->version.'/shop_category/del/items', $parameters);
    }
}
